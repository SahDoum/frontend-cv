...
export const introApp = createApp({
...
introApp.component("text-box", TextBox);
introApp.component("pong", Pong);


export const examplesApp = createApp({
    data() {
        return {}
    },
    async mounted() {
        await new Promise(r => setTimeout(r, 500));
        this.$refs.examples_img.startLoader();
    },
});
examplesApp.component("image-loader", ImageLoader);


export const tbApp = createApp({
    data() {
        return {}
    },
    async mounted() {
...
tbApp.component("text-box", TextBox);
